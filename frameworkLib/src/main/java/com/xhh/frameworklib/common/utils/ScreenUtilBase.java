...
import com.xhh.frameworklib.common.config.CodeBase;


public class ScreenUtilBase {
    /**
     * 获得屏幕高度
     *
     * @param context
    ...
    public static void setStatusBarColor(Activity act, int color) {
        int colorBar = -1;
        if (color == CodeBase.System.DefaultColor) {
            colorBar = R.color.default_blue;
        } else if (color == CodeBase.System.Immersive) {
            colorBar = Color.TRANSPARENT;
        } else if (color == CodeBase.System.DefaultLight) {
