...
class LineGraphicView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        mPaint.setColor(res.getColor(R.color.color_1a4da8));
        ...
        mPaint.setColor(res.getColor(R.color.color_1cc568));
    ...
    private void drawAllXLine(Canvas canvas) {
        for (int i = 0; i < spacingHeight + 1; i++) {
            ...
            drawText(String.valueOf(averageValue * i+1250) , blwidh / 2, bheight - (bheight / spacingHeight) * i + marginTop,
                    canvas);
        }
    }
